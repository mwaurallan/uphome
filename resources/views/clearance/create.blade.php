                        ...
                        <form method="post" action="{{ route('clearance.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="adm_no"  class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name" value="{{$bills[0]->adm_no}}" required readonly>
                                    {{--  {{ $material_details ?: 'default value' }}  --}}
                                    {{--  {{ $errors->has('id_no') ? ' is-invalid' : '' }}                                                                             --}}
                                    @include('alerts.feedback', ['field' => 'adm_no'])
                                </div>
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name">Admission Number2</label>
                                    <input type="text" name="adm_no2"  class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Name" value="{{$bills[0]->adm_no}}" required readonly>
                                    {{--  {{ $material_details ?: 'default value' }}  --}}
                                    {{--  {{ $errors->has('id_no') ? ' is-invalid' : '' }}                                                                             --}}
                                    @include('alerts.feedback', ['field' => 'adm_no'])
                                </div>

                ...
                <form method="post" action="" autocomplete="off">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="password_confirmation" class="form-control" placeholder="" value="{{$clients->id}}" required>
                        </div>
                        <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                            <label><p>Name_of_Deceased</p></label>
                            <input type="text" name="Name_of_Deceased" class="form-control" placeholder="" value="{{$clients->name_of_deceased}}" required>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Name" value="{{$clients->location}}">
                            @include('alerts.feedback', ['field' => 'name'])
                        </div>

                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                            <label><p>ID No:</p></label>
                         <input type="text" name="id_no" class="form-control" placeholder="ID Number" value="{{ $clients->id_no }}">
                        ...
                        <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="tel_no" class="form-control" placeholder="Telephone Number" value="{{$clients->witness}}" required>
                        ...
                        <div class="row">
                            <div>
                                <div class="form-group{{ $errors->has('stock') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="county" id="home_area" class="form-control" value="{{$clients->release_date}}"required>
                            ...
                            <div class="col-4">
                                <div class="form-group{{ $errors->has('stock_defective') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="subcounty" id="subcounty" class="form-control" value="{{$clients->permit_no}}">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-price"><p>Relationship</p></label>
                                    <input type="text"  name="location" id="home_area" class="form-control" value="{{$clients->county}}">

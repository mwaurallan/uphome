        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8">
                            <h4 class="card-title">Sub Counties</h4>
                        </div>
                                ...
                                @foreach ($subcounties as $subcounty)
                                    <tr>
                                        ...
                                        <td class="td-actions text-right">
                                            <a href="{{ route('products.show', $subcounty) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="More Details">
                                                <i class="tim-icons icon-zoom-split"></i>
                                            </a>
                                            <a href="{{ route('products.edit', $subcounty) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Product">
                                                <i class="tim-icons icon-pencil"></i>
                                            </a>
                                            <form action="{{ route('products.destroy', $subcounty) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('delete')
